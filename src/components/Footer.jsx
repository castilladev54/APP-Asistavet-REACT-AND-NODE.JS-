...
const Footer = () => {
    return (
        <footer className="relative w-full bg-[#020617] mt-10 border-t border-white/5 pt-16 pb-8 overflow-hidden">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-16 lg:px-24">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 lg:gap-16 mb-16">
                    ...
                    <article className="flex flex-col gap-4">
                        ...
                        <p className="text-slate-400 font-light leading-relaxed">
                            Cuidando de la salud y el bienestar de tu mascota de manera integral. Porque ellos merecen lo mejor, brindamos atención dedicada las 24 horas.
                        </p>
                    </article>
                    ...
                    <address className="flex flex-col gap-4 not-italic">
                        ...
                        <div className="flex gap-4 mb-2">
                            {/* Instagram */}
                            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-300 hover:text-white hover:bg-orange-500/20 hover:border-orange-500/50 hover:shadow-[0_0_15px_rgba(249,115,22,0.4)] transition-all duration-300" aria-label="Instagram">
                            ...
                            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-300 hover:text-white hover:bg-zinc-700/50 hover:border-zinc-500/50 hover:shadow-[0_0_15px_rgba(255,255,255,0.2)] transition-all duration-300" aria-label="GitHub">
                                <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                        ...
                        <div className="text-slate-400 font-light text-sm mt-2 flex flex-col gap-1">
                            ...
                            <a href="tel:+5804260383454" className="hover:text-orange-400 transition-colors max-w-max">+58 (0426) 038 34 54</a>
                        </div>
                    </address>
                </div>
                ...
                <div className="pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-slate-500 font-light">
                    ...
                    <p className="flex items-center gap-1">
                        Desarrollado con <span className="text-orange-500 text-lg">♥</span> por tu dev de confianza
                    </p>
                </div>
            </div>
        </footer>
